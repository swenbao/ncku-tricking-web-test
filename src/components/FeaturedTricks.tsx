        ...
        >
          <CarouselContent>
            <CarouselItem className="sm:basis-1/2 md:basis-1/3 lg:basis-1/4">
              <Card className="overflow-hidden bg-card/30 border-0 shadow-[0_0_15px_5px_rgba(255,255,255,0.07)] hover:shadow-[0_0_20px_8px_rgba(255,255,255,0.1)] transition-all duration-300 transform hover:-translate-y-1 backdrop-blur-sm">
            ...
            <CarouselItem className="sm:basis-1/2 md:basis-1/3 lg:basis-1/4">
              <Card className="overflow-hidden bg-card/30 border-0 shadow-[0_0_15px_5px_rgba(255,255,255,0.07)] hover:shadow-[0_0_20px_8px_rgba(255,255,255,0.1)] transition-all duration-300 transform hover:-translate-y-1 backdrop-blur-sm flex flex-col justify-center items-center">
